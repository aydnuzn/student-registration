...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorObject> courseRegistrationException(CourseRegistrationException ex, WebRequest request) {
        ErrorObject message = new ErrorObject(
                HttpStatus.NOT_ACCEPTABLE.value(),
                new Date(),
                ex.getMessage(),
                request.getDescription(false));
        return new ResponseEntity<ErrorObject>(message, HttpStatus.NOT_ACCEPTABLE);
    }
